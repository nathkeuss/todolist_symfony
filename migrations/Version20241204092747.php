 ...
 */
final class Version20241204092747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tag_project (project_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_1D82FD44166D1F9C (project_id), INDEX IDX_1D82FD44BAD26311 (tag_id), PRIMARY KEY(project_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
